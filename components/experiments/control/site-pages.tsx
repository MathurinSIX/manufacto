    ...
    <header className="bg-[#fff8f0]">
      <div className="mx-auto grid max-w-[1274px] gap-8 px-5 py-12 md:grid-cols-2 md:items-center md:py-16">
        <div>
          ...
          <div className="mt-5 max-w-xl space-y-3 text-xl leading-normal text-black/75">
...
export function MockupAtelierPage({
  scope = "site",
  heroLead = "test",
}: {
  scope?: SiteScope;
      ...
      <section id="concept" className="scroll-mt-28 mx-auto max-w-[1274px] px-5 py-14">
        ...
        <div className="mt-5 max-w-3xl space-y-5 text-xl leading-normal text-black/75">
          <p>
            ...
            travailler le bois, le textile, la terre ou l&apos;électronique dans
            un espace adapté et avec des machines de qualité.
          </p>
          <p>
            Situé au cœur du 5ème arrondissement, l&apos;atelier rassemble
            plusieurs espaces de pratique&nbsp;: menuiserie, couture, céramique
            et électronique.
          </p>
        </div>
          ...
          <div className="mt-12 grid gap-10 md:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)] md:items-start md:gap-14">
            <div className="max-w-2xl space-y-5 text-xl leading-normal text-black/75">
              <p>
                ...
                créatifs. Chacun d&apos;entre eux a son espace, ses outils, ses
                machines.
              </p>
              <p>
        ...
        lead={
          <>
            <p>
              ...
              autonomie complète ou encadrée. Votre réservation vous donne accès aux
              machines et outils de l&apos;atelier.
            </p>
            <p>
              Créez un compte, chargez des crédits (valables un an), réservez vos
              créneaux, et c&apos;est parti.
            </p>
          </>
        }
        ...
        <div className="mx-auto max-w-[1274px] space-y-16 px-5 py-14">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-lg text-black/65">
              Les créneaux en autonomie encadrés ne remplacent pas un cours :
              pour apprendre à utiliser une machine ou maîtriser une technique,
              voyez le{" "}
