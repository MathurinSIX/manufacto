  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <footer className="border-t border-black/10 bg-white">
        <div className="mx-auto grid max-w-[1280px] gap-10 px-5 py-12 md:grid-cols-[1fr_187px_187px_187px] md:px-0">
          <div>
          ...
          <div className="space-y-6 text-base font-medium leading-normal">
