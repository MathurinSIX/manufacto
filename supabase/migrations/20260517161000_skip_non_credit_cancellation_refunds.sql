-- Only wallet-credit registrations should create credit ledger entries.
-- Square-paid registrations are refunded through Square and must not receive credits back.
